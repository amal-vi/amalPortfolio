  ...
  return (
    <footer className={styles.footer}>
      <div className={styles.connectSection}>
        <Link className={styles.icons} to="https://instagram.com/"  target="_blank" rel="noopener noreferrer">
          < BsInstagram/>
        </Link>
        ...
        <Link className={styles.icons} to="https://x.com/" target="_blank" rel="noopener noreferrer">
          <BsTwitterX/>
        </Link>
